...
For each $\Gamma_i$ we know $\xi_i^\star$ such that:
\begin{equation}
\Gamma_i(\vec{C} + \xi_i^\star \vec{\nu}_i) = 0
\end{equation}
and we know exactly the function in the direction $\vec{\nu}_i$.
\begin{equation}
\Gamma_i(\vec{C} + \xi \vec{\nu}_i) = 0
\end{equation}

\begin{equation}
\Gamma_i(\vec{C} + \delta\vec{C}) = 
\Gamma_i\left(\vec{C} + 
\left[ \dfrac{\langle\delta\vec{C}\vert\vec{\nu}_i\rangle}{\vec{\nu}_i^2} \vec{\nu}_i \right]
+
...
\underbrace{\left[ \Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) - (\xi_i - \xi_i^\star)
\langle \vec{\Psi}_i^\star \vert \vec{\nu}_i \rangle \right]}_{g_i(\xi_i)}
+  (\xi_i - \xi_i^\star) \langle \vec{\Psi}_i^\star \vert \vec{\nu}_i\rangle
\end{equation}
...
g_i(\xi_i^\star)  & = & 0 \\
g'_i(\xi_i^\star) & = & 0 \\
g_i(0) & = & \Gamma_i + \xi_i^\star \langle \vec{\Psi}_i^\star \vert \vec{\nu}_i \rangle \\
g'_i(0) & = & \langle \vec{\Psi}_i - \vec{\Psi}_i^\star \vert \vec{\nu}_i \rangle\\
\end{array}
\right.
\end{equation}
...
\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) \simeq g_i(\xi_i) 
+ (\xi_i - \xi_i^\star) \langle \vec{\Psi}_i^\star \vert \vec{\nu}_i\rangle
+ \langle \vec{\Psi}_i \vert \bm{\nu}^t \vert \vec{\chi}_i \rangle
+ \frac{1}{2} \langle \vec{\chi}_i \vert \bm{\nu}\bm{H}_i\bm{\nu}^t \vert \vec{\chi}_i \rangle
\end{equation}
 
\begin{equation}
(1-\alpha_i^2) \Gamma_i   \simeq g_i(\xi_i) 
+ (\xi_i - \xi_i^\star) \langle \vec{\Psi}_i^\star \vert \vec{\nu}_i\rangle
+ \langle \vec{\Psi}_i \vert \bm{\nu}^t \vert \vec{\chi}_i \rangle
+ \frac{1}{2} \langle \vec{\chi}_i \vert \bm{\nu}\bm{H}_i\bm{\nu}^t \vert \vec{\chi}_i \rangle
\end{equation} 
...
\begin{equation}
\langle \vec{\Omega}_i \vert \vec{\xi} \rangle = \xi_i^\star + \dfrac{1}{\langle \vec{\Psi}_i^\star \vert \vec{\nu}_i\rangle}
\left[
 (1-\alpha_i^2) \Gamma_i - g_i(\xi_i) + \frac{1}{2} \langle \vec{\chi}_i \vert \bm{\nu}\bm{H}_i\bm{\nu}^t \vert \vec{\chi}_i \rangle
\right]
\end{equation} 
