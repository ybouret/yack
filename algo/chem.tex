...
We look for a $\delta \xi_i^\star$ that will decrease $|\xi_i^\star+\delta \xi_i^\star|$
...
\begin{array}{rcl}
	0
		&\simeq &\langle \vec{\Psi_i}^\star \vert \bm{\nu}^t \delta\vec{\xi} \rangle \\
	&+& \delta\xi_i^\star \langle \vec{\Psi_i}^\star \vert \vec{\nu}^t_i  \rangle\\
	& + & \frac{1}{2} \langle \delta\vec{\xi} \vert \bm{\nu}\bm{H}_i^\star \bm{\nu}^t \vert \delta\vec{\xi} \rangle \\
	& + & \frac{1}{2} \langle \vec{\nu}^t_i  \vert \bm{H}_i^\star \vert \vec{\nu}^t_i  \rangle {\delta\xi_i^\star}^2\\
	& + & \langle \vec{\nu}^t_i  \vert \bm{H}_i^\star \bm{\nu}^t \vert \delta\vec{\xi} \rangle \delta\xi_i^\star\\
\end{array}
\end{equation} 
...
\begin{array}{rcl}
	0
		&\simeq &\langle \vec{\Omega}_i  \vert \delta\vec{\xi} \rangle \\
	&+& \delta\xi_i^\star \\
	& + & \frac{1}{2} \langle \delta\vec{\xi} \vert \bm{\nu}\bm{\bar H}_i^\star \bm{\nu}^t \vert \delta\vec{\xi} \rangle \\
	& + & \frac{1}{2} \langle \vec{\nu}^t_i  \vert \bm{\bar H}_i^\star \vert \vec{\nu}^t_i  \rangle {\delta\xi_i^\star}^2\\
	& + & \langle \vec{\nu}^t_i  \vert \bm{\bar H}_i^\star \bm{\nu}^t \vert \delta\vec{\xi} \rangle \delta\xi_i^\star\\
\end{array}
\end{equation} 
...
\left(
	...
	+ 
\begin{bmatrix}
\delta \xi_1^\star \langle \vec{\nu}^t_1  \vert \bm{\bar H}_1^\star \bm{\nu}^t \vert \\
\ldots\\
\ldots\\
\end{bmatrix}
\right) \delta\vec{\xi} + \delta\vec{\xi}^\star 
\end{equation}
