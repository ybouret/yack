...
We want:
\begin{equation}
	\Gamma_i\left(\vec{C} + \delta\vec{C} + \xi_i^\star \vec{\nu}^t_i  \right) \simeq
	\langle \vec{\Psi_i}^\star \vert \delta\vec{C} \rangle + 
	\dfrac{1}{2} \langle \delta\vec{C} \vert \bm{H}_i^\star \vert \delta\vec{C} \rangle
\end{equation}
