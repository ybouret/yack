...
\left\lbrace
\begin{array}{rcl}
	\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) & \simeq & \Gamma_i + B_i \xi_i + A_i \xi_i^2\\
	-\Gamma_i & = & B_i \Xi_i   + A_i \Xi_i  \\
	 \beta_i   & = & B_i + 2 A_i \Xi_i  \\
...
\left\lbrace
\begin{array}{rcl}
 \Xi_i^2 A_i & = & \Xi_i \beta_i + \Gamma_i \\
 \Xi_i B_i & = & -2\Gamma_i - \Xi_i \beta_i = \Xi_i \beta_i - 2A_i\\
\end{array}
\right.
\end{equation}
...
\begin{array}{rcl}
	\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) & \simeq &
	\Gamma_i + B_i \xi_i + A_i \xi_i^2 \\
	\\
	& + & \displaystyle \sum_{k\not=i} \langle \vec{\Psi}_i \vert \vec{\nu}_k \rangle \xi_k \\
	\\
	& + & \displaystyle \xi_i \sum_{k\not=i} \langle \bm{H}_i \vec{\nu}_i \vert \vec{\nu}_k \rangle \xi_k\\
\end{array}
\right.
\end{equation}
