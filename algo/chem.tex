...
\begin{equation}
\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) = - \langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle \left[ (\Xi_i-\xi_i) - A_i (\Xi_i-\xi_i)^2 \right]
\end{equation}

\begin{equation}
	\Xi_i^2 A_i = \Xi_i - \left(\dfrac{\Gamma_i(\vec{C})}{-\langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle} \right)
\end{equation}

\begin{equation}
\dot\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) = \langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle \left[ 1 + 2A_i (\xi_i-\Xi_i) \right]
\end{equation}

\begin{equation}
	\dot\Gamma_i(\vec{C}) = \langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle \left[ 1 - 2A_i  \Xi_i \right] = \langle \vec{\Psi}_{i_0} \vert \vec{\nu}_i \rangle
\end{equation}
...
\begin{equation}
	\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i + \sum_{k\not=i} \xi_k \vec{\nu}_k ) \simeq \Gamma_i(\vec{C} + \xi_i \vec{\nu}_i) 
	+ \langle \vec{\Psi_{\xi_i}} \vert \sum_{k\not=i} \xi_k \vec{\nu}_k \rangle
\end{equation}
