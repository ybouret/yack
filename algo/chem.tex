...
\begin{equation}
	(1-\alpha_i)\Gamma_i = \sigma_i (\xi_i-\Xi_i) + A_i (\xi_i-\Xi_i)^2 + \sum_{j\not=i} \langle \vec{\Psi}_i \vert \vec{\nu}_j \rangle \xi_j
\end{equation}
...
\end{equation}
 ...
 \begin{equation}
	  - \alpha_i \Gamma_i = \sigma_i \xi_i   + A_i \xi_i^2  - 2 A_i \xi_i \Xi_i   + \lambda_i
\end{equation}

\begin{equation}
	0 = A_i \xi_i^2  - [A_i\Xi_i + (A_i\Xi_i - \sigma_i)] \xi_i + \lambda_i  + \alpha_i \Xi_i (A_i \Xi_i  -\sigma_i)
\end{equation}
