...
\end{array}
\end{equation}
The bracket expression is (quadrically) decreasing from $1-\alpha_i$ to $\alpha_i$,
...
\begin{equation}
	\bm{\Omega} \vec{\xi}_0 =  \vec{\alpha} \otimes \vec{\gamma} \Rightarrow \vec{\xi}_0 = \bm{\Omega}^{-1} \vec{\alpha} \otimes \vec{\gamma} 
\end{equation} 
...
\begin{equation}
	\bm{\Omega} \vec{\xi}_1 = 
	   \vec{\alpha} \otimes \vec{\Xi}
	    + \vec{A} \otimes \left[ (\vec{\xi}_0-\vec{\Xi})^{[2]} - \left(\vec{1}-\vec{\alpha}\right)\otimes \vec{\Xi}^{[2]}\right]
\end{equation}
