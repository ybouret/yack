...
\begin{equation}
	...
	\underbrace{\langle \vec{\nu}_i \vert \vec{\Psi}_i' \rangle}_{\sigma_i<0} (\xi_i-\Xi_i) + \square_i   (\Xi_i-\xi_i)
...
\left\lbrace
\begin{array}{rcl}
 \Gamma_i & = & -\sigma_i \Xi_i + \square(\Xi_i) \\
 \square_i(\Xi_i) & = & \Gamma_i + \sigma_i \Xi_i\\
 \square_i(0) & = & 0\\
 \square_i'(0) & = & 0\\
 \vec{\Psi}_{\xi_i} & \simeq & \left(1-\dfrac{\xi_i}{\Xi_i}\right) \vec{\Psi}_i + \dfrac{\xi_i}{\Xi_i} \vec{\Psi}_i'\\
\end{array}
\right.
\end{equation}
...
We want:
\begin{equation}
(1-\alpha_i) \Gamma_i = \sigma_i \left(\xi_i - \Xi_i\right) + \square_i\left(\Xi_i-\xi_i\right) + 
\sum_{j\not=i}  \langle \vec{\Psi}_i \vert \vec{\nu}_j \rangle \xi_j
+\sum_{j\not=i}  \dfrac{\xi_i}{\Xi_i}\langle \Delta\vec{\Psi}_i \vert \vec{\nu}_j \rangle \xi_j
\end{equation}
