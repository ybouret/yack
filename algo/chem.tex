...
\begin{array}{rcl}
\Gamma_i(\vec{C} + \xi \vec{\nu}_i) & = &
 [1-\omega_i(\xi)]\left(\Gamma_i+\sigma_i \xi\right) + 
 \omega_i(\xi) \sigma_i^\star (\xi-\xi_i^\star)\\
 \omega_i(0) & = & 0\\
 \omega_i(\xi_i^\star) & = & 1 \\
 \end{array}
 \right.
...
\left\lbrace
\begin{array}{rcl}
\Gamma_i'(\xi) &=& \omega'_i(\xi) \left[ \sigma_i^\star (\xi-\xi_i^\star) -\left(\Gamma_i+\sigma_i \xi\right)\right]
+ [1-\omega_i(\xi)] \sigma_i + \omega_i(x)  \sigma_i^\star\\
\Gamma_i'(0) & = & \sigma_i = -\omega'_i(0) \left[ \Gamma_i + \sigma_i \xi_i^\star\right] \\
\Gamma_i'(\xi_i^\star) & = & \sigma_i^\star = -\omega'_i(\xi_i^\star) \left[ \Gamma_i + \sigma_i \xi_i^\star\right]\\
\end{array}
\right.
\end{equation}
