...
\begin{array}{rcl}
 ...
 \Xi_i B_i & = &  \Xi_i \beta_i + 2A_i\Xi_i^2\\
\end{array}
\right.
\end{equation}
...
\left\lbrace
\begin{array}{rcl}
	\dfrac{\Gamma_i(\vec{C} + \xi_i \vec{\nu}_i+ \sum_{k\not=i} \xi_k \vec{\nu}_k)}{-\beta_i} & \simeq & 
	\dfrac{\Gamma_i}{-\beta_i} - (1+\dfrac{2A\Xi_i}{\beta_i})\xi_i + \dfrac{A_i}{\beta_i} \xi_i^2\\
	\\
	& - & \displaystyle \sum_{k\not=i} \dfrac{ \langle \vec{\Psi}_i \vert \vec{\nu}_k \rangle }{ \langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle}\xi_k\\
	\\
	& - & \displaystyle \xi_i \sum_{k\not=i} \dfrac{\langle \bm{H}_i \vec{\nu}_i \vert \vec{\nu}_k \rangle}{\langle \vec{\Psi}_i' \vert \vec{\nu}_i \rangle} \xi_k \\
\end{array}
\right.
\end{equation}
