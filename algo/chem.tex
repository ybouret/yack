...
\begin{equation}
	\vec{\nabla} \dfrac{1}{2} \left[\vec{S}_i - \mathbb{E}(\vec{S})\right]^2
\end{equation}

\begin{equation}
	\bm{J}_i = \partial_{\vec{X}} \left(\dfrac{\langle \vec{\Psi}_i^\star \vert  \vec{X} \rangle}{\langle \vec{\Psi}_i^\star \vert \vec{\nu}_i \rangle
}\vec{\nu}_i\right) = 
\dfrac{1}{\langle \vec{\Psi}_i^\star \vert \vec{\nu}_i \rangle} 
\vert \vec{\nu}_i \rangle \langle \vec{\Psi}_i^\star 
\end{equation}

\begin{equation}
	\partial_{\delta\vec{C}} (\vec{S}_i - \mathbb{E}(\vec{S}))= - \bm{J}_i + \dfrac{1}{\sum w_k}\sum_j w_j \bm{J}_j
\end{equation}

\begin{equation}
	\vec{\nabla} \dfrac{1}{2} \left[\vec{S}_i - \mathbb{E}(\vec{S})\right]^2 = 
	\left(-\bm{J}_i^t + \mathbb{E}(\bm{J}^t) \right) \left[\vec{S}_i - \mathbb{E}(\vec{S})\right]
\end{equation} 

\begin{equation}
	L^2 = \dfrac{1}{2\sum w_k}\sum_j w_j \left[\vec{S}_i - \mathbb{E}(\vec{S})\right]^2
\end{equation}

The decreasing direction for $L^2$ is:
\begin{equation}
	-\partial_{\delta\vec{C}} = 
\end{equation}
