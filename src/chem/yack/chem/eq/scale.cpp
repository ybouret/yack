...
namespace yack
{
    namespace chemical
    {
        ...
        double equilibrium::  scale(const double            K0,
                                    const readable<double> &C,
                                    writable<double>       &Ctry) const
        {
            ...
            switch( __sign::of(g0) )
            {
                ...
                case positive: {
                    ...
                    //---------------------------------------------------------_
                    return sfwd(K0,C,Ctry,g0);

                case negative:
                    //----------------------------------------------------------
                    // need to move reverse
                    //----------------------------------------------------------
                    return srev(K0,C,Ctry,g0);
                }
        ...
        double equilibrium:: sfwd(const double            K0,
                                  const readable<double> &C,
                                  writable<double>       &Ctry,
        ...
        double equilibrium:: srev(const double            K0,
                                  const readable<double> &C,
                                  writable<double>       &Ctry,
                                  const double            g0) const
        {
