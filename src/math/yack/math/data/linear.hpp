//! \file
//!
#ifndef YACK_MATH_LINEAR_INCLUDED
#define YACK_MATH_LINEAR_INCLUDED 1
...
namespace yack
{
    ...
    namespace math
    {
        ...
        inline U linear(  T x, const readable<T> &X, const readable<U> &Y )
        {
